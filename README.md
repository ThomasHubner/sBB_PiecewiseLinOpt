...
The code in *main.jl* reads the csv-file and hands the problem information to a function in *MIP_solver.jl* which solves the problem by using predefined MIP-models.s
